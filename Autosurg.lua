...
function Maisner(dialog)
Maisner = {}
Maisner.v0 = "OnDialogRequest"
Maisner.v1 = dialog
SendVariant(Maisner)
end
dialog = [[
add_label_with_icon|big|`cAuto Surg by `4Maisner#0513|left|]] .. 7068 .. [[|
add_spacer|small|
add_smalltext|`9This script are free! `4DO NOT TRY TO SELL MY SCRIPT!|left|
add_textbox|`!Join My Discord Server|left|
add_url_button|comment|Discord|noflags|https://discord.gg/PB6MtxsQDN|`^Go to Discord Server?|0|0|
add_spacer|small|
add_button||OK|
]]
Maisner(dialog)
